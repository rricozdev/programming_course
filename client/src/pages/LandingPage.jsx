...
const LandingPage = () => {
  ...
  const handleClick = () => {
    setLoading(true); // Mostrar el spinner
    setTimeout(() => {
      navigate("/payment"); // Navegar después de un tiempo
    }, 1000); // Ajusta el tiempo según sea necesario
  };
      ...
      <div className="flex-grow">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-center h-16">
              <div className="flex-shrink-0 ml-2">
                <img src={logo} alt="Logo" className="h-8 w-1xs" />
              </div>
        ...
        <section className="pt-16 relative">
          <div className="relative bg-black text-white min-h-screen flex items-center">
            <div className="max-w-7xl mx-auto px-4 py-12 h-full flex flex-col md:flex-row items-center md:justify-between gap-6">
              {/* Texto e información */}
              <div className="text-center md:text-left md:w-1/2">
                <h1 className="text-4xl md:text-5xl font-bold mb-6">
                  <span className="text-[#FFDF20]">Impulsa tu carrera</span> en
                ...
                <div className="flex flex-col space-y-4">
                  <div className="flex items-center space-x-2">
                    <Cast className="w-6 h-6 text-yellow-400" />
                    <span>Online y en vivo.</span>
                  </div>

                  <div className="flex items-center space-x-2">
                    <BookOpen className="w-6 h-6 text-yellow-400" />
                    <span>Basado en proyectos reales</span>
                  </div>
                ...
                <button className="mt-6 px-6 py-3 bg-yellow-400 text-black font-bold text-lg rounded-lg shadow-lg hover:bg-yellow-300 transition-all duration-300 cursor-pointer" onClick={handleClick}>
                  Adquirir ahora
                </button>
              </div>
