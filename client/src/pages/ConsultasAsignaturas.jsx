        ...
        <div className="max-w-3xl mx-auto mb-12 bg-gray-800 bg-opacity-50 p-6 rounded-xl border-l-4 border-yellow-400 shadow-lg">
          <div className="flex items-start">
            ...
            <p className="text-lg leading-relaxed">
              ¿Tienes tareas que hacer y no entiendes el tema? 🤯 No te preocupes,
              estamos aquí para ayudarte. Si estás atascado con ejercicios de cálculo,
              estructuras de datos o cualquier otra asignatura, podemos guiarte paso a
              paso. No pierdas más tiempo buscando respuestas en internet, consulta
              con nosotros y resuelve tus dudas al instante. ¡Haz que tus tareas sean
              más fáciles y aprende de verdad! 🚀✨
            </p>
          </div>
        </div>
